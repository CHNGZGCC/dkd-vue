<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="合作商名称" align="center" style="width: 100px;" prop="partnerName" />
    ...
    <!-- 查看合作商详情对话框 -->
    <el-dialog title="合作商详情" v-model="partnerInfoOpen" width="600px" append-to-body>
...
function resetPwd(row) {
  const _id = row.id;
  proxy.$modal.confirm('你确定要重置密码吗？').then(function() {
